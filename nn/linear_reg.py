...
def draw_weight_hist(ax, w0_hist, w1_hist):
    ax.plot(w0_hist, w1_hist)
    ax.set_xlabel('w0')
    ax.set_ylabel('w1')
...
def run(args):
    ...
    draw_weight_hist(axes[2, 1], w0_hist, w1_hist)
...
def main():
    ...
    parser.add_argument('-e', '--learn-factor', type=float, default=0.06)
    parser.add_argument('-nl', '--num-learning', type=int, default=100)
